...
- Integrate optional affiliate tags only through `HasOptionalTags` and `TagIntegration` from `misaf/vendra-support`. Reserve the `affiliate` type; never import Vendra Tagger or Spatie Tags, and keep Tagger in Composer `suggest` rather than `require`.
