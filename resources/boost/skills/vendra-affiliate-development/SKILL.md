...
- Add or update focused Pest coverage, then run `composer --working-dir=packages/vendra-affiliate test` and `composer --working-dir=packages/vendra-affiliate analyse`.
